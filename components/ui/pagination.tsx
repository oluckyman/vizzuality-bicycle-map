...
const PaginationPrevious = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => {
  ...
  return (
    <PaginationLink
      ...
      size="default"
      className={cn("gap-1 pl-2.5", className, isDisabled ? ["pointer-events-none opacity-50"] : [])}
      {...props}
    >
...
const PaginationNext = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => {
  ...
  return (
    <PaginationLink
      ...
      tabIndex={isDisabled ? -1 : undefined}
      size="default"
      className={cn("gap-1 pr-2.5", className, isDisabled ? ["pointer-events-none opacity-50"] : [])}
      {...props}
    >
      <span>Next</span>
...
const PaginationFirst = ({ className, ...props }: React.ComponentProps<typeof PaginationLink>) => {
  ...
  return (
    <PaginationLink
      ...
      tabIndex={isDisabled ? -1 : undefined}
      size="default"
      className={cn("gap-1 px-2.5", className, isDisabled ? ["pointer-events-none opacity-50"] : [])}
      {...props}
    >
      <ChevronLeft className="h-4 w-4" />
